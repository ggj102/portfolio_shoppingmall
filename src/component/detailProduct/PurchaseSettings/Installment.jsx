...
function Installment({ onClose }) {
  return (
    <div className="popup_card">
      <div className="inner_text">
        <strong className="popup_title">무이자 할부 카드 안내</strong>
        <button className="exit_btn" onClick={onClose}>
          X
        </button>
        <div className="card_notice">
          <div className="symbolmark">
            법인카드 (개인사업자 카드포함)는 무이자 할부 혜택이 제공되지
            않습니다.
          </div>
          <div className="symbolmark">
            BC카드의 경우 BC마크가 없는 경우 무이자 할부 혜택이 제공되지
            않습니다.
          </div>
        </div>
        <ul>
          <li className="item_card">
            <div className="bland_img">
              <img src={Kb} alt="img" />
            </div>
            <div className="card_text_area">
              ...
              <div className="card_text">
                <span className="card_month">
                  10개월 부분무이자(1,2,3개월 고객부담)
                </span>
                <span className="card_price">5만원 이상</span>
              </div>
              <div className="card_text">
                <span className="card_month">
                  12개월 부분무이자(1,2,3,4개월 고객부담)
                </span>
                <span className="card_price">5만원 이상</span>
              </div>
            </div>
